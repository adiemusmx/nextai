#include "gl_window.h"												/**< 包含GLwindows.h头文件 */
...
namespace Trinity {
	...
	/** 创建windows窗口 */
	bool GL_Window::Create(const WCHAR * window_title, const WCHAR * class_name, HINSTANCE h_instance, LPVOID lpParam)
	{
		int nX = 0;
		int nY = 0;
